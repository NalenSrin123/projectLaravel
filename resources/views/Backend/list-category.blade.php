                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="{{route('edit-category',$item->id)}}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <input type="hidden" id="remove_val" name="remove_id" >
                  <button type="submit" class="btn btn-danger">Confirm</button>
                  <a  href="{{route('list-category')}}" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</a>
                </div>
              </div>
            </div>
          </form>
