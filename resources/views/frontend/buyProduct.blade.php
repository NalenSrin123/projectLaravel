                ...
                <div class="col-lg-6 px-5 py-4">
                  ...
                  <div class="d-flex align-items-center mb-5">
                    <div class="flex-shrink-0">
                      <img src="{{url('images/'.$product->thumbnail)}}"
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="def-number-input number-input safari_only">
                                <button type="button" onclick="changeQuantity(this, -1)" class="minus"></button>
                                <input class="quantity fw-bold text-black" min="1" name="quantity" value="{{$quantity}}" type="number">
                                <button type="button" onclick="changeQuantity(this, 1)" class="plus"></button>
                            </div>
                        </form>
                      </div>
                    </div>
                ...
                <div class="col-lg-6 px-5 py-4" style="display:flex; flex-direction: column">
                  ...
                  <form action="{{route('buy-product-submit',$product->id)}}" class="mb-5" method="post">
                    ...
                    <div class="row" style="margin-left: 200px">
                        <img src="/code.jpg" alt=""  style="width: 200px;">
                    </div>
                    ...
                    <h5 class="fw-bold mb-5" style="position: absolute; bottom: 0; right: 70px;">
                      <a href="{{route('product',$product->id)}}"><i class="fas fa-angle-left me-2 "></i>Back to shopping</a>
                    </h5>
